 ...
 */
    ...
    public void SearchForAKeyword(){
        ...
        Reuseable_Actions.sendKeysMethod(driver,"//*[@name='q']","Cars","Google Search");
        //submit
        Reuseable_Actions.submitMethod(driver,"//*[@name='btnK']","Submit Button");

    }//end of test 1

    @Test(priority = 2)
    public void CaptureSearchNumber(){
        String result = Reuseable_Actions.getTextMethod(driver,"//*[@id='result-stats']","Search Result");
